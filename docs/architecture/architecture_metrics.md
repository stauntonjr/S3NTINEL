...
- System AST span LOC: `54890`
- Largest module LOC share: `4.11%`
- Largest component LOC share: `21.25%`
- Top three components LOC share: `35.55%`
...
| libs.scoring.tables | libs/scoring/tables.py | 1038 | core_libraries | core_libraries.scoring |
...
| libs.anomaly.frames | libs/anomaly/frames.py | 922 | core_libraries | core_libraries.anomaly |
...
| libs.scoring.tables.WindowScoresRawTable | libs/scoring/tables.py | 612 |
| libs.profiling.profiles.ParameterBehaviorPrimitiveProfile | libs/profiling/profiles.py | 597 |
| libs.anomaly.frames.AnomalyParameterLocalizationFrame | libs/anomaly/frames.py | 500 |
...
| libs.scoring.tables.WindowScoresRawTable.from_phase_dataframes | libs/scoring/tables.py | 578 |
...
| libs.anomaly.frames.AnomalyParameterLocalizationFrame.from_calibrated_phase_windows_events_and_hierarchy | libs/anomaly/frames.py | 357 |
...
| --- | --- | ---: | ---: | ---: |
| Simulation | core_libraries | 11666 | 62 | 21.25% |
| Phase | core_libraries | 4332 | 14 | 7.89% |
| Graph | core_libraries | 3513 | 13 | 6.40% |
| Events | core_libraries | 3493 | 9 | 6.36% |
| Tuning | core_libraries | 3479 | 13 | 6.34% |
| Windows | core_libraries | 3442 | 8 | 6.27% |
| Architecture Workflow | architecture_tooling | 2881 | 7 | 5.25% |
| Anomaly | core_libraries | 2279 | 5 | 4.15% |
| Scoring | core_libraries | 2085 | 4 | 3.80% |
| Io | core_libraries | 2073 | 16 | 3.78% |
| Fitting Stages | pipeline_runtime | 2066 | 10 | 3.76% |
| Behavior | core_libraries | 1910 | 12 | 3.48% |
| Profiling | core_libraries | 1552 | 4 | 2.83% |
| Perf | core_libraries | 1088 | 6 | 1.98% |
| Repo Mapping Tools | architecture_tooling | 1029 | 2 | 1.87% |
| Inference Stages | pipeline_runtime | 973 | 6 | 1.77% |
| Performance And Replay Utilities | simulation_clis | 885 | 3 | 1.61% |
| Backbone | core_libraries | 817 | 5 | 1.49% |
| Config | core_libraries | 642 | 2 | 1.17% |
| Grouped Pipeline Runners | pipeline_runtime | 565 | 4 | 1.03% |
| Spark Sequence | core_libraries | 274 | 2 | 0.50% |
| Pyspark | core_libraries | 201 | 4 | 0.37% |
