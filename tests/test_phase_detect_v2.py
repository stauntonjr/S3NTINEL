...
from libs.phase import build_structure_vectors, detect_phases_from_windows, evaluate_detected_phases
...
def test_build_structure_vectors_uses_selected_sensors_and_event_types():
    ...
    structured, feature_names = build_structure_vectors(
        windows,
...
def test_detect_phases_from_windows_separates_low_drift_clusters():
    ...
    assignments, baselines = detect_phases_from_windows(windows, phase_count=2, stable_drift_quantile=0.5)
...
def test_detect_phases_from_windows_enforces_minimum_dwell():
    ...
    assignments, _ = detect_phases_from_windows(
        windows,
        phase_count=2,
