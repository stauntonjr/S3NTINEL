...
def test_stream_profiler_validation_confusion_counts_and_monotonicity():
    simulator_rows = [
        {"tail_id": "T1", "flight_id": "F1", "sensor": "S1", "timestamp_utc": _ts(0), "parameter_datatype_label": "numeric"},  # TP
        {"tail_id": "T1", "flight_id": "F1", "sensor": "S1", "timestamp_utc": _ts(1), "parameter_datatype_label": "numeric"},  # mismatch FP+FN
        {"tail_id": "T1", "flight_id": "F1", "sensor": "S1", "timestamp_utc": _ts(2), "parameter_datatype_label": "binary"},  # missing profiler FN
        {"tail_id": "T1", "flight_id": "F1", "sensor": "S1", "timestamp_utc": _ts(3), "parameter_datatype_label": ""},  # TN
    ]
    profiler_rows = [
        {"tail_id": "T1", "flight_id": "F1", "sensor": "S1", "timestamp_utc": _ts(0), "parameter_datatype_profiled": "numeric"},
        {"tail_id": "T1", "flight_id": "F1", "sensor": "S1", "timestamp_utc": _ts(1), "parameter_datatype_profiled": "categorical"},
        {"tail_id": "T1", "flight_id": "F1", "sensor": "S1", "timestamp_utc": _ts(8), "parameter_datatype_profiled": "numeric"},  # orphan FP
    ]
...
def test_stream_profiler_validation_without_orphan_fp():
    simulator_rows = [
        {"tail_id": "T1", "flight_id": "F1", "sensor": "S1", "timestamp_utc": _ts(0), "parameter_datatype_label": "numeric"},
    ]
    profiler_rows = [
        {"tail_id": "T1", "flight_id": "F1", "sensor": "S1", "timestamp_utc": _ts(0), "parameter_datatype_profiled": "numeric"},
        {"tail_id": "T9", "flight_id": "F9", "sensor": "S9", "timestamp_utc": _ts(9), "parameter_datatype_profiled": "binary"},
    ]
    snapshots = list(
        stream_profiler_validation(
            simulator_rows=simulator_rows,
    ...
    with pytest.raises(ValueError, match="parameter_datatype"):
        list(
            simulator_datatype_label_rows(
                [{"tail_id": "T1", "flight_id": "F1", "sensor": "S1", "timestamp_utc": _ts(0), "parameter_datatype": "numeric"}]
            )
        )
    ...
    with pytest.raises(ValueError, match="detected_type"):
        list(
            profiler_datatype_rows(
                [{"tail_id": "T1", "flight_id": "F1", "sensor": "S1", "timestamp_utc": _ts(0), "detected_type": "numeric"}]
            )
        )
