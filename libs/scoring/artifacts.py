"""In-memory window score artifact assembly."""
...
from libs.scoring.rules import score_phase_window_rows
...
class WindowScoreArtifacts:
    ...
    def from_phase_rows(
        ...
        scored_rows = score_phase_window_rows(window_rows, assignment_rows, baseline_rows)
        phase_row_by_key = {
