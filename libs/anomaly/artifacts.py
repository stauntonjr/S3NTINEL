"""Anomaly attribution dataframe assembly."""
...
@hot_path
def build_anomaly_attribution_context_table(
    *,
...
@hot_path
def build_anomaly_telemetry_attribution_table(
    *,
...
@hot_path
def build_anomaly_event_attribution_table(
    *,
    calibrated_df: "DataFrame",
    windows_df: "DataFrame",
    events_df: "DataFrame",
...
@hot_path
def build_anomaly_window_attribution_from_context_table(
    *,
    calibrated_df: "DataFrame",
