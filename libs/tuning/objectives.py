...
def _full_objective_spec() -> ObjectiveSpec:
    return ObjectiveSpec(
        ...
        primary_terms=(
            ...
            ObjectiveTerm(
                metric=_metric("validation", "overall", "score_validation", "detected_fault_window_rate"),
                direction="maximize",
                weight=2.5,
                label="detected fault window rate",
            ),
            ObjectiveTerm(
                metric=_metric("validation", "overall", "score_validation", "emit_ready_fault_window_rate"),
                direction="maximize",
                weight=1.5,
                label="emit-ready fault window rate",
            ),
            ObjectiveTerm(
                metric=_metric("validation", "overall", "attribution_validation", "dominant_subsystem_match_rate"),
                direction="maximize",
                weight=2.0,
                label="dominant subsystem match rate",
            ),
            ObjectiveTerm(
                metric=_metric("validation", "overall", "attribution_validation", "telemetry_parameter_match_rate"),
                direction="maximize",
                weight=1.5,
                label="telemetry parameter match rate",
            ),
            ObjectiveTerm(
                metric=_metric("validation", "overall", "attribution_validation", "event_parameter_match_rate"),
                direction="maximize",
                weight=1.0,
