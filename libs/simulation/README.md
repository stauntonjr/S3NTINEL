...
`power_pressurization_hierarchy_smoke_localization_focus_bias` keeps only the
`bias` case and exists as the clean subsystem-localization acceptance gate on
the smoke topology.
...
- `power_pressurization_hierarchy_smoke_localization_focus_bias`
  - use as the clean subsystem-localization acceptance gate
