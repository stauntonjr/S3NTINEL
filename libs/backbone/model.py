...
class BackboneSensorEnergy:
    ...
    @classmethod
    def from_window_x_rows(
        cls,
        window_x_rows: list[dict[str, Any]],
        *,
        ...
        return [
            ...
            for row in compute_window_sensor_energy(window_x_rows)
        ]
...
class BackboneModel:
    ...
    def from_window_x_rows(
        ...
        *,
        ...
        sensor_energies = BackboneSensorEnergy.from_window_x_rows(
            window_x_rows,
