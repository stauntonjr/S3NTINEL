...
ACTIVE_V2_TABLES = {
    ...
    "hierarchy_edge_evidence": HIERARCHY_EDGE_EVIDENCE_COLUMNS,
    ...
    "phase_reference_model": PHASE_REFERENCE_MODEL_COLUMNS,
    ...
    "anomaly_parameter_candidate_evidence": ANOMALY_PARAMETER_CANDIDATE_EVIDENCE_COLUMNS,
