...
def WINDOWS_SCHEMA():
    ...
    return T.StructType(
        [
            ...
            T.StructField("quiet_credit_end", T.DoubleType(), False),
            T.StructField("closure_budget_end", T.DoubleType(), False),
...
def WINDOW_X_SCHEMA():
    ...
    return T.StructType(
        [
            ...
            T.StructField("continuous_vector_t_start", double_map, True),
            T.StructField("continuous_vector_t_start_scaled", double_map, True),
            T.StructField("continuous_vector_t_end", double_map, False),
            T.StructField("continuous_vector_t_end_scaled", double_map, False),
            T.StructField("categorical_state_t_start", string_map, True),
...
def WINDOW_POLICY_PROFILE_SCHEMA():
    ...
    return T.StructType(
        [
            ...
            T.StructField("budget_threshold_close_rate", T.DoubleType(), False),
            ...
            T.StructField("mean_quiet_credit_end", T.DoubleType(), False),
            T.StructField("p95_quiet_credit_end", T.DoubleType(), False),
            T.StructField("mean_closure_budget_end", T.DoubleType(), False),
            T.StructField("p95_closure_budget_end", T.DoubleType(), False),
